...
Nesse projeto foi desenvolvi um Formulário de matrícula para uma escola de educação infantil. 
Foram utilizados diversos tipos de input. Além de rever e treinar o CSS.
